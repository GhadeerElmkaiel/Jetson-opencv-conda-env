#!/bin/bash
# Most of this code is build on JetsonHacks code on (https://github.com/jetsonhacks/buildOpenCVXavier) buildOpenCV.sh file
...
PYTHON_DIR=/media/ubuntu/SSD1/archiconda3/envs/ANS-py36/bin/python
...
function usage
{
    ...
    echo "-p | --python_path Directory of the python want to use (in case of virtual envs or conda envs define the python of the used env)"
...
# The used scripts file is from JetsonHacks repository on (https://github.com/jetsonhacks/buildOpenCVXavier)
